      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-4">
          ...
          <div className="flex gap-4 items-center">
            ...
            <p className="text-sm text-gray-500">80000 reviews & 8000 ratings</p>
          </div>

          <div>
            <h3 className="text-green-500 font-semibold text-xl">Special Price</h3>
            <p className="text-3xl font-bold text-slate-700">Rs. {products.price}</p>
          </div>
          ...
          <div className="mt-4">
            <p className="font-semibold text-slate-800">
              Ratings:
              <span className="text-blue-500 font-bold ml-2">{products.rating}</span>
            </p>
            <p className="font-semibold text-slate-800 mt-2">
              Available:
              <span className="text-blue-500 font-bold ml-2">{products.count}</span> pcs
            </p>
          </div>
        </div>
      </div>
