          ...
          <table className=" w-full">
            <thead>
              <tr>
                ...
                <th>Order Summary</th>
                <th>Status</th>
                <th className="px-2 text-nowrap">Delete</th>
              </tr>
            </thead>
            <tbody className=" w-full">
              {orders.map((order, index) => (
                <tr
                  key={order.id || index}
                  className="border-3 border-black bg-white even:bg-slate-100 even:text-black"
                >
                  ...
                  <td className="text-center text-nowrap border px-4 py-2">
                    {order.address}
                  </td>
                  ...
                  <td className="text-center border px-10 py-2">
                    <input
                      type="checkbox"
                      checked={order.orderstatus === "completed"} // or true/false depending on your data
                      onChange={async () => {
                        try {
                          const updatedStatus =
